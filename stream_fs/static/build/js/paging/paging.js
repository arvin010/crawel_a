...
document.write("<script type='text/javascript' src='{{static_url("+"js/project-list.js"+")}}'></script>");
...
(function(root, factory) {
	...
	Paging.prototype = {
		...
		bindToolbar: function() {
			var _this = this;
			var html = $('<li class="ui-paging-toolbar"><select class="ui-select-pagesize"></select><input type="text" class="ui-paging-count"/><a href="javascript:void(0)">确认</a></li>');
			...
			sel.html(str);
			sel.val(pagesize=this.pagesize);
			psize=this.pagesize
			// search(this.current,this.pagesize)
			...
			$('a', html).click(function() {
				...
				console.log("page  click...",current)
				getpage(current,pagesize=psize)
				_this.go(current);
			});
			sel.change(function() {
